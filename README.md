...
> **Compliant with the National Digital Health Mission (NDHM)** – HeartGuard follows guidelines for health data portability, consent management, and patient privacy as outlined by NDHM/ABDM standards.

## Key Features

### 🏥 Patient Features
- **Heart Disease Risk Assessment** - AI-powered prediction using 6-model ensemble
- **Lifestyle Risk Inputs** - Tobacco use, obesity, BMI, exercise, diet, stress level, genetics
- **Risk Score Gauge** - Visual gauge showing risk percentage on dashboard
- **AI Personalized Health Tips** - Gemini-powered tips based on assessment data
- **Voice Assistant** - Speech-to-Text input for assessment form (Web Speech API)
- **Family & Caregiver Dashboard** - Link dependents, monitor their reports
- **Gamification** - Walk 5,000+ steps daily to earn Heart Points & badges
...
- **Account Management** - Update profile, view QR code, change password, link dependents
- **Pathology Lab Locator** - Google Maps integration for nearby labs (post-assessment)
- **Offline Risk Calculator** - Service Worker + JS heuristic for offline usage
...
- **Report Verification with Doctor Notes** - Add clinical notes before approving/rejecting
...
- **Automated Patient Alert** - Patient receives notification after doctor verifies report

### 🔒 Security & Compliance
- Compliant with **National Digital Health Mission (NDHM)** guidelines for health data portability and privacy.
...
- **Gemini AI Integration** - Personalized health tips generation

### 🤖 AI & Smart Features
- **24/7 AI Health Chatbot** - Gemini-powered cardiac health Q&A (base.html widget)
- **SOS Emergency Button** - Persistent emergency call button on every page
- **Medication & Water Reminders** - Browser push notifications on schedule
- **Multi-Language Support** - Google Translate widget for 100+ languages
- **Service Worker** - Offline-capable assessment and caching
...
### Input Features (Lifestyle & Genetic) — V4
- BMI (Body Mass Index)
- Tobacco Use (No / Past / Current)
- Obesity (Yes / No)
...
- **AI**: Google Gemini 2.5 Flash (Chatbot & Health Tips)
...
- **Maps**: Google Maps Embed API (Pathology Lab Locator)
...
- [ ] Wearable device data integration (Apple Watch, Fitbit)
- [ ] FHIR API for interoperability with ABDM ecosystem
...
**v4.0** - Full AI-Powered Cardiac Ecosystem (NDHM Compliant)  
**Release Date:** April 17, 2026  
**Last Updated:** April 17, 2026

### Changelog (v3.2 → v4.0)
- Added: Lifestyle risk factors (tobacco, obesity, BMI, exercise, diet, stress, genetics)
- Added: Risk Score Gauge on patient dashboard
- Added: AI Health Tips via Google Gemini
- Added: 24/7 AI Health Chatbot widget
- Added: Voice Assistant (Speech-to-Text) for assessment
- Added: Family & Caregiver profile linking + dashboard
- Added: Gamification (Heart Points for daily steps)
- Added: SOS Emergency button (global)
- Added: Doctor Notes on report verification
- Added: Medication & Water intake notifications
- Added: Multi-language support (Google Translate)
- Added: Pathology Lab Locator (Google Maps)
- Added: Offline Risk Calculator (Service Worker)
- Added: NDHM compliance documentation
- Upgraded: Version to v4.0
